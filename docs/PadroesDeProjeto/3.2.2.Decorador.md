...
[![Gravação Diagrama Strategy](https://img.youtube.com/vi/J2H_Tz10bG8/0.jpg)](https://youtu.be/J2H_Tz10bG8)
<iframe width="560" height="315"
  src="https://www.youtube.com/embed/J2H_Tz10bG8"
  title="Gravação Diagrama Decorator" frameborder="0"
  allowfullscreen></iframe>

Link da reunião em: https://youtu.be/J2H_Tz10bG8
...
| Gabriel Lopes de Amorim| Diagrama Decorator e Documentação | Contribuição na elaboração do diagrama e na escrita da documentação do padrão. | Achei interessante trabalhar com o Decorator porque ele mostra bem como adicionar funcionalidades sem mexer no código original. Durante a elaboração do diagrama, consegui entender melhor como funciona essa ideia de "embrulhar" um objeto com outro para adicionar comportamentos. O que mais me chamou atenção foi a flexibilidade de poder combinar os decoradores de diferentes formas, tipo usar o log antes e o bônus depois. Por outro lado, percebi que pode acabar gerando muitas classes pequenas, o que pode complicar um pouco quando o projeto crescer. Também vi que precisa tomar cuidado com a ordem que coloca os decoradores, porque isso muda o resultado final. No geral, foi produtivo trabalhar no diagrama e na documentação, principalmente fazendo junto com a equipe, porque ajudou a fixar melhor o conceito do padrão.|
...
![livro Design Patterns](../assets/decorator.png)
...
| 1.2    | Correção das imagens quebradas e adição de embed dos vídeos | [Artur Mendonça Arruda](https://github.com/ArtyMend07) | 24/10/2025 |  | 
| 1.3    | Adição da contribuição e da análise crítica |  [Gabriel Lopes de Amorim](https://github.com/BrzGab) | 24/10/2025 |  | |

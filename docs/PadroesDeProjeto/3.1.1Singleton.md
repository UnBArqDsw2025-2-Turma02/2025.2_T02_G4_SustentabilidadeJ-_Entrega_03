...
O diagrama do Singleton foi desenvolvido pelos integrantes responsáveis com base nos materiais da professora, como slides e vídeo-aulas, no livro Design Patterns: Elements of Reusable Object-Oriented Software e na interpretação direta do código-fonte da classe TokenService.
...
[![Teste Singleton](https://img.youtube.com/vi/RYR31CU8nts/0.jpg)](https://youtu.be/RYR31CU8nts)
<iframe width="560" height="315"
  src="https://www.youtube.com/embed/RYR31CU8nts"
  title="YouTube video player" frameborder="0"
  allowfullscreen></iframe>
  
Link da reunião em: https://youtu.be/RYR31CU8nts
...
**Fonte:** Elaborada pelos autores [Artur Mendonça Arruda](https://github.com/ArtyMend07), [Gabriel Lopes](https://github.com/BrzGab), e [Lucas Mendonça Arruda](https://github.com/lucasarruda9)
...
[![Assista à gravação](https://img.youtube.com/vi/5hhxbg8col4/0.jpg)](https://youtu.be/5hhxbg8col4)
<iframe width="560" height="315"
  src="https://www.youtube.com/embed/5hhxbg8col4"
  title="YouTube video player" frameborder="0"
  allowfullscreen></iframe>

Link da reunião em: https://youtu.be/5hhxbg8col4
...
| Gabriel Lopes de Amorim | Diagrama Singleton, código  | Contribuí de forma ativa na elaboração do artefato, participando da escrita da introdução e auxiliando na implementação do código relacionado ao padrão Singleton. Também colaborei parcialmente na construção da metodologia e na revisão geral do documento, garantindo a coerência entre o diagrama, o código e a explicação teórica.| Considero que o desenvolvimento do padrão Singleton foi um ótimo exercício de compreensão da lógica de controle de instâncias e do uso de recursos compartilhados. O processo me ajudou a entender melhor a importância da estrutura e do encapsulamento no código. A experiência foi produtiva e reforçou minha capacidade de integrar conceitos teóricos à prática de programação. |
...
![livro Design Patterns](../assets/referencias/singleton_ref.png)
...
| 1.4    | Adicionando contribuição e análise crítica | [Gabriel Lopes de Amorim](https://github.com/BrzGab) | 24/10/2025 |  | |
| 1.5    | Correção das imagens quebradas e adição de embed dos vídeos | [Artur Mendonça Arruda](https://github.com/ArtyMend07) | 24/10/2025 |  | 

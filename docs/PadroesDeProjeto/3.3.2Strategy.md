...
Link do vídeo pro Youtube: [Teste Strategy](https://youtu.be/RYR31CU8nts)
...
> <a id="FRM2" href="#anchor_2">2.</a>GAMMA, Erich; HELM, Richard; JOHNSON, Ralph; VLISSIDES, John. *Design Patterns: Elements of Reusable Object-Oriented Software*. Boston: Addison-Wesley, 1994, p. 317.
...
| 1.1    | adicionando diagrama, análise do código, e melhorando metodologia | [Artur Mendonça Arruda](https://github.com/ArtyMend07), [Gabriel Lopes ](https://github.com/BrzGab) e [Lucas Mendonça Arruda](https://github.com/lucasarruda9) | 24/10/2025 |  | |
